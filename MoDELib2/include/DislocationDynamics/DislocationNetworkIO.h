...
//            }
            ...
            //if(DN.outputSlipSystemPlasticDistortion)
            //{
            //    const std::map<std::pair<int,int>,double>& pSD(DN.slipSystemPlasticDistortion());
            //    //f_file<<pD.row(0)<<" "<<pD.row(1)<<" "<<pD.row(2)<<" "<<pD.trace()<<" "<<pD.norm()<<" ";
            ...
            //        for(const auto& p: pSD){
            //            const std::pair<int,int>& key=p.first;
            //            F_labels<<"betaPgrainID"<<key.first<<"ssID"<<key.second<<"\n";
            //        }
            //    }
            //}
